...
export default async function globalSetup() {
  ...
  await setup({
    command: `IPFS_PATH=\'${GOIPFS_DIR_PATH.pathname}\' CERAMIC_ENABLE_EXPERIMENTAL_COMPOSE_DB=\'true\' pnpm dlx @ceramicnetwork/cli@^2.8.0-rc.0 daemon --config ${CONFIG_PATH.pathname}`,
    debug: true,
