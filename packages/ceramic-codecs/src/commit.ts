...
export const CommitCodec = io.union(
  [
...
export type Commit = io.TypeOf<typeof CommitCodec>
...
export const CommitDataCodec = createCommitDataCodec(CommitTypeCodec, CommitCodec, 'CommitData')
