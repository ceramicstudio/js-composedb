...
```mdx-code-block
import App from '../components/HomepageFeatures/App';
...
```mdx-code-block
<div style={{height: "60rem", width: "100%", margin: "auto"}}><App appProps='profiles' /></div>
```
<br />
---
...
```mdx-code-block
<div style={{height: "60rem", width: "100%", margin: "auto"}}><App appProps='posts' /></div>
```
<br />
---
...
```mdx-code-block
<div style={{height: "60rem", width: "100%", margin: "auto"}}><App appProps='comments' /></div>
```
