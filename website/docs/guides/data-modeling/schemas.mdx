...
:::tip
We currently support a subset of SDL’s scalars and directives, but are continually adding more. See our [SDL reference](../../api/sdl/scalars.mdx) for a complete list.
:::
...
:::tip 
On this page, we only provide basic info for you to begin writing GraphQL data models. For more complete info on the GraphQL Schema Definition Language, visit [GraphQL's website](https://graphql.org/learn/schema/).
:::
...
## Next Steps
---
Learn how to add [**Relations**](../data-modeling/relations.mdx) to your schema.