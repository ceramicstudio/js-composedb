...
💡 For this to work, you will want to define both shapes inside the same GraphQL file when writing ComposeDB schemas. Certain Directives are also required by ComposeDB.
...
💡 Strings are required to have the maxLength directive when used in ComposeDB
