...
After deploying your composite, compile it so you can start perform [Data Interactions](../../guides/data-interactions) using the [ComposeDB Client](../../guides/composedb-client)
...
[`composedb graphql:schema runtime-composite.json --output=schema.graphql`](../../api/commands/cli.graphql#composedb-graphqlschema)
...
## Next Steps
- [ComposeDB Client Setup](../../guides/composedb-client) to set up your server and configure your app
- [Data Interactions](../../guides/data-interactions) to interact with data using your composite

## Related Guides
- [Model Catalog](../../guides/data-modeling/model-catalog)
- [Writing Models](../../guides/data-modeling/writing-models)