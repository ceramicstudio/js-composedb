...
- [Account to model relations](#account-to-model-relations)
- [Model to account relations](#model-to-account-relations)
- [Model to model relations](#model-to-model-relations)
- [Account to account relations](#account-to-account-relations)
...
## Next Steps
---
Now that you understand the fundamentals of creating models with different types of relations, let's create a [**composite**](../data-modeling/composites.mdx) so we can use them in our app.