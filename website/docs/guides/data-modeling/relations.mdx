...
## Model to Account
Model to account relations enable you to link data to and query data from an account other than the data’s author. When using this type of relation, you need to define a model field that stores an account (e.g. a [DID](https://composedb.js.org/docs/0.3.x/guides/creating-composites/scalars#did)), then add the `@accountReference` directive to make it queryable.
...
## Next Steps
Now that you understand the fundamentals of creating models with different types of relations, you should proceed to learning mode about how you create composites using them. Head to [Composites](https://www.notion.so/Composites-d92f5986e2594ada841586efb21bb5a4) next to learn more.