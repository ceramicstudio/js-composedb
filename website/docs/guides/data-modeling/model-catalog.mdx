...
1. A developer deploys [Composites](https://www.notion.so/Composites-d92f5986e2594ada841586efb21bb5a4) containing models to testnet or mainnet
...
You need a running instance of ComposeDB to use the catalog. See [Set up your environment](https://www.notion.so/Set-up-your-environment-59be80c854464ed5ae32303253f7750d) to get started.
...
## Related Guides
Can’t find what you’re looking for in the catalog? Visit [Writing Models](https://www.notion.so/Writing-Models-e829e0e595574a0d90987f9acdc011f0) to learn how to write your own models.