...
- Before your client can perform queries on those models, you need to [compile your composite](../data-modeling/composites). [`ComposeClient`](../../api/classes/client.ComposeClient.md) automatically generates a GraphQL Schema from your compiled composite
