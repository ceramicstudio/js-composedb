...
- Before your client can perform queries on those models, you need to [compile your composite](../data-modeling/composites). [`ComposeClient`](../../api/classes/client.ComposeClient) automatically generates a GraphQL Schema from your compiled composite
...
The `CeramicAccount` object replaces [`DID` scalars](../../api/sdl/scalars#did) in your composite with the following fields:
...
## Next Steps
Head to the next section, [**Mutations**](./mutations), to learn how to write or modify data on the network. 

## Related Guides
- For additional context on the types of account and model relations, see the [**Relations**](../data-modeling/relations) guide
- To learn how to compile and deploy a composite, see [**Composites**](../data-modeling/composites) 