...
## Additional Usage
Once you authorize and create a session, you can serialize and store session for later. Sessions by default are valid for 7 days. 
...
1. Setting up [**Data Interactions**](../../guides/data-interactions) 
2. Being able to use [**mutations**](../../guides/data-interactions/mutations) with ComposeDB client