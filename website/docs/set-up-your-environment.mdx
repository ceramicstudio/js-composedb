...
**Important:** [Ceramic Anchor Service (CAS)](https://developers.ceramic.network/docs/composedb/guides/composedb-server/access-mainnet) is used to anchor Ceramic streams on a blockchain.
...
If you are ready to dive into a more advanced configuration, head to [**Wheel reference page→**](https://developers.ceramic.network/docs/wheel/wheel-reference) to learn more details about each parameter you can configure.
