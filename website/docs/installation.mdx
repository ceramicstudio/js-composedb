...
ComposeDB runs on [Ceramic](https://ceramic.network/). Running [a local Ceramic node](https://developers.ceramic.network/build/cli/installation/) is needed for app development.
