...
find a model that you need, you should create one indirectly by [creating a Composite](https://developers.ceramic.network/docs/composedb/guides/data-modeling/composites) from a GraphQL Composite Schema.
