...
The group of [CLI](../modules/cli.md) `graphql:*` commands makes it possible to generate GraphQL Schemas from compiled [Composites](https://ceramicnetwork.github.io/docs-docusaurus/docs/composedb/guides/data-modeling/composites) and run a local GraphQL HTTP server
...
You will be using this schema in your app to perform [Queries](https://ceramicnetwork.github.io/docs-docusaurus/docs/composedb/guides/data-interactions/queries) and [Mutations](https://ceramicnetwork.github.io/docs-docusaurus/docs/composedb/guides/data-interactions/mutations).
