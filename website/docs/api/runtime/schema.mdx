...
The other fields present in document objects are generated based on the [model's definition](https://developers.ceramic.network/docs/composedb/guides/data-modeling/writing-models) and possibly added [views](../sdl/directives.mdx#views).
...
Example [Schema definition](https://developers.ceramic.network/docs/composedb/guides/data-modeling/schemas):
