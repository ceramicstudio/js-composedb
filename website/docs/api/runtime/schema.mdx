...
Filtering inputs can be used as arguments to [Connection](#connections) queries in order to filter the documents returned by the query based on the value of fields present in the document.
...
Similar to [filtering inputs](#filtering), sorting inputs can be used as arguments to [Connection](#connections) queries in order to order the documents returned by the query based on the value of fields present in the document.
