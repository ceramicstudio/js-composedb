...
>💡 Before proceeding you must have [set up your environment](./set-up-your-environment) in the previous step
...
![Data Model Table](https://s3.us-west-2.amazonaws.com/secure.notion-static.com/dcee19b2-54b7-46b5-bfe3-9ea0a9dd5b7a/Screenshot_2022-11-16_at_14.59.07.png?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=AKIAT73L2G45EIPT3X45/20221206/us-west-2/s3/aws4_request&X-Amz-Date=20221206T180011Z&X-Amz-Expires=86400&X-Amz-Signature=cf6fbcf46fca88ef34a039a5c5292275f9c3816e2d49dc9a1fe793f6c7b43e72&X-Amz-SignedHeaders=host&response-content-disposition=filename=%22Screenshot%25202022-11-16%2520at%252014.59.07.png%22&x-id=GetObject)
...
## Next steps
Now that you have created your composite, you are ready to use it: **[Interact with data](/interact-with-data) →**
