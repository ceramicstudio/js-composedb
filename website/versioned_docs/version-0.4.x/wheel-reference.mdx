...
This reference explains Wheel promt options and covers Ceramic configurations in more detail.
...
- `Mainnet` - for projects in the production stage. This option will require you to do more advanced configurations for
 your working environment. Opt for this option only when you are ready to move your application to production stage.
...
### CAS Authentication
In order to control the nodes connected to CAS (Ceramic Anchor Service), you will have to configure the authentication. This will allow
 you to set or revoke DIDs for your nodes. You can choose from the following options:
