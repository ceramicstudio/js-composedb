...
You can use this command to test how document creation works, but in your live app you will use ComposeDB GraphQL [Mutations](https://developers.ceramic.network/docs-docusaurus/docs/composedb/guides/data-interactions/mutations) instead.
...
You can use this command to test how document updates work, but in your live app you will use ComposeDB GraphQL [Mutations](https://developers.ceramic.network/docs-docusaurus/docs/composedb/guides/data-interactions/mutations).
