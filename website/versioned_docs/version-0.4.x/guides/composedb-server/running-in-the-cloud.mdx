...
1. Clone the [ceramic-infra-scripts repo](https://github.com/ceramicstudio/ceramic-infra-scripts.git) and enter the created directory.

```
git clone https://github.com/ceramicstudio/ceramic-infra-scripts.git
