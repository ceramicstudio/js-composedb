...
- This guide is focused on running in the cloud using docker. If you use npm, you can follow the same steps as [Running Locally [Deployed]](../../guides/composedb-server/running-locally.mdx).
