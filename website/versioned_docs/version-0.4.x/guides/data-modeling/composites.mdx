...
### Creating Models
Let's say you have a model as in [Schemas](./schemas.mds). You will first save that model to a graphql file, `education_module.graphql`. You can then create your model with
