...
<details>
  <summary>Which node version is preferred?</summary>
  <div>
    <div>
...
<details>
  ...
  <div>
    <div>
      ...
      it's easy to forget that you need to run all of the commands in the app's directory. With
      JavaScript package managers you need to open 2-3 terminal windows and run different commands,
      so it's easy to miss that you can be in a wrong directory. Please make sure you run all the
      commands where they're supposed to run.
    </div>
  </div>
</details>
<details>
  ...
  <div>
    <div>
      ...
      (*not* in the app directory). It's easy to miss this details so please check the path. This
...
<details>
  <summary>How do I interact with the data once the node is running?</summary>
  <div>
    <div>
      You interact with data through a GraphQL Server. You can find all the details on how to set it
...
<details>
  <summary>What if my question not answered on this page?</summary>
  <div>
    <div></div>
    <div>
      If your question is not answered in this guide, we recommend visiting our Community Forum or
      joining our Discord server (see links in the footer). There, you can ask your question and get
      help from our community of developers and users. Both places are great to ask anything: from
      beginner to expert questions. The community and our developers are there to help you.
    </div>
  </div>
</details>
