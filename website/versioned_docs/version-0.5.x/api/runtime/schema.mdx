...
The other fields present in document objects are generated based on the [model's definition](https://developers.ceramic.network/docs-docusaurus/docs/composedb/guides/data-modeling/writing-models) and possibly added [views](../sdl/directives.mdx#views).

For example, using the following [Schema definition](https://developers.ceramic.network/docs-docusaurus/docs/composedb/guides/data-modeling/schemas):
...
Example [Schema definition](https://developers.ceramic.network/docs-docusaurus/docs/composedb/guides/data-modeling/schemas):
