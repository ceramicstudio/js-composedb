...
Before jumping into configuring your local environment, start querying a real dataset right away using our [ComposeDB API Sandbox](../../sandbox).

The next step to build with ComposeDB is setting up your development environment. Currently, there are two ways of how you can configure your working environment:
