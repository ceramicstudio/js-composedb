...
ComposeDB runs on top of [Ceramic](https://ceramic.network/). Running [a local Ceramic node](https://developers.ceramic.network/docs-docusaurus/docs/composedb/set-up-your-environment) is needed for app development.
