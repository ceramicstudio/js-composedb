...
-  **Config Script:** We’d love to make [Set up your environment](https://www.notion.so/Set-up-your-environment-c5657dce889842828ba54de6026b29bc) even easier. Want to create a lightning fast script?


### **Open source contributions**

Contribute to the [ComposeDB codebase](https://github.com/ceramicstudio/js-composedb) -- here are some good repositories to get started:
...
### **Project showcase**
- Reach out on the Ceramic Discord channel [#ComposeDB](https://discord.gg/6FCS44YDBs) and tag `@core-devs` to show off your project on CompsoeDB
